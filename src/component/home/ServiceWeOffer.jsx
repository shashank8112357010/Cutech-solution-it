                ...
                <Slider
                    ...
                    {data.map((item, index) => (
                        <div key={index} className="mr-4 flex justify-center items-center gap-12 ">
                            <div className='sm:mx-4 transition-all duration-300 h-[270px] w-[290px] sm:w-[320px] lg:w-[500px] pb-8 sm:px-4 ease-in-out flex-grow border-2 border-[#E7DAED] shadow-custom justify-center flex flex-col px-2 sm:p-3 sm:my-8 gap-2 rounded-[9px] '>
