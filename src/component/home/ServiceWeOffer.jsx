        ...
        <section className='sm:mb-20 max-w-[1920px] mx-auto serviceWeOffer'>
            ...
            <div className='w-full !flex !flex-row relative !justify-between !items-center gap-0 md:gap-8 pl-1 overflow-hidden'>
                <div className=" absolute z-50 leftArrow left-4 sm:left-16 block cursor-pointer"
                    onClick={next}
                >
                    <img src="/img/testimonial/TestimonialLeftArrow.webp" className=" h-8 md:h-12 w-8 md:w-12" alt="Testimonial LeftArrow" />
                </div>
                ...
                <div className="block absolute z-50 rightArrow right-4 sm:right-16 cursor-pointer"
                    onClick={previous}
                >
                    <img src="/img/testimonial/TestimonialRightArrow.webp" className=" h-8 md:h-12 w-8 md:w-12" alt="Testimonial RightArrow" />
                </div>
            </div>
