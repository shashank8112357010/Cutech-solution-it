...
export const Services = () => {
    return (
        <>
            <BannerAtom srcImg="/img/services/ServicesBanner.webp" title="Our Services" heading="Our Services" />
            <Solutions />
            <ServiceCards />
            ...
            <div className='max-w-[1920px] mx-auto py-4 sm:py-12 pb-16 sm:pb-24 px-4 sm:px-20'>
                <div className='flex flex-col lg:flex-row items-center lg:justify-between '>
                    ...
                    <div className='sm:w-[622px] sm:h-[450px] flex justify-end sm:justify-end lg:justify-normal mb-12 mt-0 sm:mt-10 lg:mt-0'>
                        <img src="/img/services/ServicesImg5.webp" alt="IT Helpdesk Support" className='w-full h-full object-contain' />
                    </div>
                    ...
                    <div className='flex flex-col gap-4 w-auto lg:w-1/2 md:pl-12'>
                        ...
                        {[{
                            ...
                            <div key={index} className='w-full flex flex-row items-center mt-2'>
                                <img src='/img/services/ServicesTick.webp' alt='Computer Cyber Security Service Solutions' className='w-4 h-4 sm:w-8 sm:h-8 mt-2' />
